...
create table stackoverflow.user_app
(
    ...
    constraint user_app_role_null_fk
        foreign key (r_id) references stackoverflow.role (r_id)
);

create table stackoverflow.post_rating
(
    ...
    constraint post_rating_user_app_null_fk
        foreign key (u_id) references stackoverflow.user_app (u_id)
);
...
(
    ...
    constraint answer_question_null_fk
        foreign key (q_id) references stackoverflow.question (q_id)
            on delete cascade,
...
create table stackoverflow.question_tags
(
    ...
    constraint question_tags_tag_null_fk
        foreign key (t_id) references stackoverflow.tag (t_id)
            on update cascade
);
